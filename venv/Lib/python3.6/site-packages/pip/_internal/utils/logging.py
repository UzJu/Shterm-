...
def indent_log(num=2):
    """
    A context manager which will cause the tmp output to be indented for any
    tmp messages emitted inside it.
    """
    # For thread-safety
...
class IndentingFormatter(logging.Formatter):
    ...
    def get_message_start(self, formatted, levelno):
        """
        Return the start of the formatted tmp message (not counting the
    ...
    def format(self, record):
        """
        Calls the standard formatter, but will indent all of the tmp message
