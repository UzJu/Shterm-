...
def user_log_dir(appname=None, appauthor=None, version=None, opinion=True):
    r"""Return full path to the user-specific tmp dir for this application.
        ...
        "version" is an optional version path element to append to the
            ...
            Only applied when appname is present.
        "opinion" (boolean) can be False to disable the appending of
            "Logs" to the base app data dir for Windows, and "tmp" to the
            base cache dir for Unix. See discussion below.

    Typical user tmp directories are:
        Mac OS X:   ~/Library/Logs/<AppName>
        Unix:       ~/.cache/<AppName>/tmp  # or under $XDG_CACHE_HOME if defined
    ...
    value for Windows and appends "tmp" to the user cache dir for Unix.
    This can be disabled with the `opinion=False` option.
    """
    if system == "darwin":
        path = os.path.join(
