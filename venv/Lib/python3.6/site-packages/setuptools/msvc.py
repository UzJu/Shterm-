...
class SystemInfo:
    ...
    def WindowsSdkLastVersion(self):
        ...
        str
            version
        """
        return self._use_last_dir_name(join(self.WindowsSdkDir, 'core'))
    ...
    def UniversalCRTSdkLastVersion(self):
        ...
        str
            version
        """
        return self._use_last_dir_name(join(self.UniversalCRTSdkDir, 'core'))
...
class EnvironmentInfo:
    ...
    def OSLibraries(self):
        ...
        if self.vs_ver <= 10.0:
            ...
            arch_subdir = self.pi.target_dir(x64=True)
            lib = join(self.si.WindowsSdkDir, 'core')
    ...
    def NetFxSDKLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        return [join(self.si.NetFxSdkDir, r'core\um%s' % arch_subdir)]
    ...
    def UCRTLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        lib = join(self.si.UniversalCRTSdkDir, 'core')
